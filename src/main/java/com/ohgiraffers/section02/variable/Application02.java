...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        *    그 중 기본 자료형 8가지부터 살펴보자.
        ...
        snum = 2;
        inum = 4;
        inum = 8;  // 아무 문제 없는 것 같지만 사실 뒤에 대문자 L을 붙여야 한다. 그 이유는 뒤에 형변환에서 다루게 될 것이다.

        /* 목차. 2-2. 실수를 취급하는 자료형에 값 대입 */
        fnum = 4.0f; // 실수 형태의 값에 fnum f를 붙인다.
        dnum = 8.0;

        /* 목차. 2-3. 문자를 취급하는 자료형에 값 대입 */
        ch = 'a';
        ch = 97;  // 'a'는 97였지? 그래서 숫자로도 저장할 수 있다.
