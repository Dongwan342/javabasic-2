...
public class Application03 {
    public static void main(String[] args) {
        ...
        * 2. 컴파일 에러를 발생시키지는 않지만 개발자들끼리의 암묵적인 규칙
             ...
             2.2 변수명이 합성어로 이뤄진 경우 첫 단어는 소문자, 두 번째 시작 단어는 대문자로 시작한다.
             2-3. 단어와 단어 사이의 연결을 언더스코어(_)로 하지 않는다. (타 언어 네이밍 규칙이다.)
             2-4. 한글로 변수명을 짓는 것이 가능하나, 권장하지 않는다.
...
//        int age = 20;
        ...
        int _true = 1; // 예약어는 사용할 수 없다. int 자체가 예약되어 있기 때문
        int _int = 1;
        ...
        int _1age = 20;  // 숫자로 시작하면 오류가 발생한다.
        int age1 = 20;
        ...
        /* 목차. 2. 컴파일 에러를 발생시키지 않으나 개발자들끼리의 암묵적 규칙 */
        /* 목차. 2-1. 변수명의 길이 제한은 없으나 적당히 */
        int ndjlsfnsdljfnwejfjnewpbefivbewvewvjwepnvevnjwevnewvwvenwejlvnjalnvewnvewavnjalvnajnkvlwevwaevwevwev;
        ...
        /* 목차. 2-4. 한글로 변수명을 짓는 것이 가능하지만, 권하지 않는다. */
        int 나이;
        ...
        /* 목차. 2-8. boolean 형은 의문문으로 가급적으로 긍정 형태의 네이밍을 한다. */
